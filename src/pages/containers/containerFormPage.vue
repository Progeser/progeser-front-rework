<template>
    <div class="ma-10" v-if="container">
      <v-row class=" justify-space-between align-center">
        ...
        <v-btn color="error" @click="deleteContainer()" class="align-self-center">{{ t('common.delete') }}</v-btn>
      </v-row>
      <v-col class="ma-5">
        <v-col>
        ...
        <v-col v-if="container.shape.name === 'other'">
        ...
        <v-col v-else>
          <h2 class="mr-2">{{ t('form.container.dimensions') + "(" + container.shape.dimension_names + ")" }}</h2>
          <v-textarea
  ...
  import { Container, ContainerShape } from "@/model/Container";
